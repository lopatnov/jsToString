...
const javascripttostring_1 = require("../src/javascripttostring");
describe("Null to String", () => {
    it("should convert null to string", () => {
        const actual = (0, javascripttostring_1.default)(null);
        const expected = "null";
        expect(actual).toBe(expected);
    });
    it("should convert undefined to string", () => {
        const actual = (0, javascripttostring_1.default)(undefined);
...
describe("Boolean to String", () => {
    it("should convert true", () => {
        const actual = (0, javascripttostring_1.default)(true);
        const expected = "true";
        expect(actual).toBe(expected);
    });
    it("should convert false", () => {
        const actual = (0, javascripttostring_1.default)(false);
        const expected = "false";
        expect(actual).toBe(expected);
    });
    it("should convert boolean object", () => {
        const actual = (0, javascripttostring_1.default)(new Boolean(1000));
        const expected = "true";
        expect(actual).toBe(expected);
    });
});
describe("Number to String", () => {
    it("should convert 0", () => {
        const actual = (0, javascripttostring_1.default)(0);
        const expected = "0";
        expect(actual).toBe(expected);
    });
    it("should convert numbers 0 < N < 1", () => {
        const actual = (0, javascripttostring_1.default)(0.75);
        const expected = "0.75";
        expect(actual).toBe(expected);
    });
    it("should convert negative numbers", () => {
        const actual = (0, javascripttostring_1.default)(-123);
        const expected = "-123";
        expect(actual).toBe(expected);
    });
    it("should convert positive numbers", () => {
        const actual = (0, javascripttostring_1.default)(456);
        const expected = "456";
        expect(actual).toBe(expected);
    });
    it("should convert infinity", () => {
        const actual1 = (0, javascripttostring_1.default)(Number.POSITIVE_INFINITY);
        const expected1 = "Number.POSITIVE_INFINITY";
        const actual2 = (0, javascripttostring_1.default)(Number.NEGATIVE_INFINITY);
        const expected2 = "Number.NEGATIVE_INFINITY";
        expect(actual1).toBe(expected1);
        expect(actual2).toBe(expected2);
    });
    it("should convert min/max values", () => {
        const actual1 = (0, javascripttostring_1.default)(Number.MAX_VALUE);
        const expected1 = "Number.MAX_VALUE";
        const actual2 = (0, javascripttostring_1.default)(Number.MIN_VALUE);
        const expected2 = "Number.MIN_VALUE";
        expect(actual1).toBe(expected1);
        expect(actual2).toBe(expected2);
    });
    it("should convert BigInt numbers", () => {
        const actual = (0, javascripttostring_1.default)(BigInt(9007199254740991));
...
describe("Symbol to String", () => {
    it("should convert empty Symbol", () => {
        const actual = (0, javascripttostring_1.default)(Symbol());
        const expected = "Symbol()";
        expect(actual).toBe(expected);
    });
    it("should convert Symbol with description", () => {
        const actual = (0, javascripttostring_1.default)(Symbol("Hello"));
        const expected = 'Symbol("Hello")';
        expect(actual).toBe(expected);
    });
    it("should convert built-in symbols", () => {
        expect((0, javascripttostring_1.default)(Symbol.iterator)).toBe("Symbol.iterator");
        expect((0, javascripttostring_1.default)(Symbol.asyncIterator)).toBe("Symbol.asyncIterator");
        expect((0, javascripttostring_1.default)(Symbol.hasInstance)).toBe("Symbol.hasInstance");
    });
});
describe("String to String", () => {
    it("should convert empty string", () => {
        const actual = (0, javascripttostring_1.default)("");
        const expected = '""';
        expect(actual).toBe(expected);
    });
    it("should convert a string", () => {
        const actual = (0, javascripttostring_1.default)("JavaScript value to string converter. It converts a runtime value into string value.");
    ...
    it("should convert special symbols", () => {
        const actual = (0, javascripttostring_1.default)("Check symbols: '\"\t\n—“”⚡");
...
describe("RegExp to String", () => {
    it("should convert RegExp", () => {
        const actual = (0, javascripttostring_1.default)(/s+/gi);
        const expected = "/s+/gi";
        expect(actual).toBe(expected);
    });
});
...
describe("Array to String", () => {
    ...
    it("should convert an Array", () => {
        ...
        const actual = (0, javascripttostring_1.default)(arr);
    ...
    it("should convert a typed Array", () => {
        ...
        const str = (0, javascripttostring_1.default)(arr);
    ...
    it("should convert with nestedArraysAmount = 0", () => {
        const str = (0, javascripttostring_1.default)([1, 2, 3, [4, 5, 6, [7, 8, 9]]], {
...
describe("Function to String", () => {
    it("should convert an anonymous function", () => {
        const stringFunction = (0, javascripttostring_1.default)((a, b, c) => a + b + c);
    ...
    it("should convert an named function", () => {
        function sum(...numbers) {
            return Array.prototype.reduce.call(numbers, (accumulator, currentValue) => {
                return accumulator + currentValue;
            }, 0);
        }
        const stringFunction = (0, javascripttostring_1.default)(sum);
        const actual = Function("return " + stringFunction)();
        const expected = 10;
        expect(actual(1, 2, 3, 4)).toBe(expected);
    });
    it("should convert lambda function", () => {
        const stringFunction = (0, javascripttostring_1.default)((a, b) => {
            return a * b;
        });
        const actual = Function("return " + stringFunction)();
        const expected = 12;
    ...
    it("should convert class", () => {
        const stringFunction = (0, javascripttostring_1.default)(class TestClass {
            constructor() {
    ...
    it("should work with function prototype", () => {
        ...
        const stringFunction = (0, javascripttostring_1.default)(TestClass);
        const actualClass = Function("return " + stringFunction)();
        const actualObject = new actualClass();
    ...
    it("should work with includeFunctionProperties = false & includeFunctionPrototype = false", () => {
        ...
        TestConstructor.Test1 = "Completed";
        TestConstructor.prototype.testMethod = () => "It works";
        const stringFunction = (0, javascripttostring_1.default)(TestConstructor, {
    ...
    it("should convert native functions", () => {
        const actual = (0, javascripttostring_1.default)([].map);
...
describe("Object to String", () => {
    ...
    it("should convert an Object", () => {
        const stringObject = (0, javascripttostring_1.default)({
            a: 1,
            hello: "world",
            innerObject: {
                testFunction: (x1, y1, x2, y2) => {
    ...
    it("should work with nestedObjectsAmount = 0", () => {
        const objectString = (0, javascripttostring_1.default)({
            a: "hello",
            b: true,
            c: {
                d: "world",
...
describe("Set to String", () => {
    it("should convert the empty set", () => {
        const actual = (0, javascripttostring_1.default)(new Set());
        const expected = "new Set()";
        expect(actual).toBe(expected);
    });
    it("should convert a set", () => {
        const actual = (0, javascripttostring_1.default)(new Set([1, 2, 3]));
...
describe("Map to String", () => {
    it("should convert the empty map", () => {
        const actual = (0, javascripttostring_1.default)(new Map());
...
describe("Resolve references to itself", () => {
    it("should resolve the array itself", () => {
        var x = [1, 2, 3];
        x[0] = x;
        const actual = (0, javascripttostring_1.default)(x);
    ...
    it("should resolve objects and arrays", () => {
        ...
        const actual = (0, javascripttostring_1.default)(z);
        const expected = Function(`return ${actual}`)();
        expect(expected).toBeTruthy();
    ...
    it("should resolve the function itself", () => {
        ...
        const actual = (0, javascripttostring_1.default)(Narcissus);
        const expected = Function(`return ${actual}`)();
    ...
    it("should handle self-referencing object (Issue #1)", () => {
        var obj = { a: 1, b: 2 };
        obj.self = obj;
        const actual = (0, javascripttostring_1.default)(obj);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle deep circular chain back to root (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(a);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle object with array referencing parent root (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(parent);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle complex graph with multiple interconnections (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(graph);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle nested object self-reference (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(outer);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle shared sub-arrays (Issue #1)", () => {
        var shared = [1, 2, 3];
        var arr = [shared, [shared, 4], shared];
        const actual = (0, javascripttostring_1.default)(arr);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle tree with shared leaves (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(root);
        const restored = Function(`return ${actual}`)();
    ...
    it("should handle shared function between object branches (Issue #1)", () => {
        var handler = function greet(name) {
            return "hello " + name;
        };
        var obj = {
            a: { action: handler },
    ...
    it("should handle object-array-function chain with cross-refs (Issue #1)", () => {
        ...
        const actual = (0, javascripttostring_1.default)(pipeline);
        const restored = Function(`return ${actual}`)();
