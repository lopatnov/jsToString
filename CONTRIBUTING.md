...
1. Add a new remote that points to the original project so you can sync project changes with your local copy:
   ...
   ```shell
   $ git remote add upstream https://github.com/lopatnov/jsToString
   ```
...
[issues]: https://github.com/lopatnov/jsToString/issues
[pull-requests]: https://github.com/lopatnov/jsToString/pulls
[code-of-conduct]: ./CODE_OF_CONDUCT.md
[about]: https://lopatnov.github.io/jsToString/
